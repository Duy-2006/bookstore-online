...
//            book.setDeleted(true); // Soft delete
	...
	public String inventory(Model model) {
		List<Book> lowStockBooks = bookRepo.findAll().stream().filter(b -> b.getQuantity() < 10)
	...
	public String importStock(@RequestParam("bookId") Long bookId, @RequestParam("quantity") Integer quantity,
